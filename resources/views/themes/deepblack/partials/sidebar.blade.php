<div id="sidebar">
    ...
    <div class="wallet-wrapper">
        ...
        <div class="d-flex justify-content-between mt-1">
            <a class="gold-btn btn"><i class="fa fa-wallet"></i> @lang('Deposit')</a>
            <a class="gold-btn btn"><i class="fa fa-usd"></i> @lang('Package')</a>
        </div>
    </div>
    <ul class="pb-4">
       <!-- list item -->
	   ...
	   <li class="{{menuActive(['plan'])}}">
        ...
        <li class="{{menuActive(['user.invest-history'])}}">
          <a href="{{route('user.invest-history')}}" class="sidebar-link">
             <img src="{{asset($themeTrue.'img/icon/growth-graph.png')}}" alt="@lang('invest history')"/>@lang('Purchase History')
          </a>
        </li>
       ...
       <li class="{{menuActive(['user.referral.bonus', 'user.referral.bonus.search'])}}">
        ...
        <li class="{{menuActive(['user.badges'])}}">
            <a href="{{route('user.badges')}}" class="sidebar-link">
                <img src="{{asset($themeTrue.'img/icon/refferal.png')}}" alt="@lang('badge icon')"/>@lang('RANK')
            </a>
        </li>
