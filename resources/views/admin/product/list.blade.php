                ...
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    @forelse($managePlans as $item)
                        <tr>
                            ...
                            <td data-label="@lang('Descriptione')">
                                <p class="font-weight-bold">{{ Str::words($item->description, 10)}}</p>
                            </td>

                            <td data-label="@lang('Category')">
                                <p class="font-weight-bold">{{["Category 1", "Category 2", "Category 3", "Category 4"][$item->category_id]}}</p>
                            </td>

                            <td data-label="@lang('Sub Category')">
                                <p class="font-weight-bold">{{["Sub Category 1", "Sub Category 2", "Sub Category 3", "Sub Category 4"][$item->subcategory_id]}}</p>
                            </td>
                            ...
                            <td data-label="@lang('Offer Price')">
                                <p class="font-weight-bold">{{$item->price - $item->price*($item->discount/100)}}</p>
                            </td>
                            ...
                            <td data-label="@lang('Stock')">
                                <p class="font-weight-bold">{{$item->stock}}</p>
                            </td>
