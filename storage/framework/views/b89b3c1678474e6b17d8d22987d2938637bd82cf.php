            ...
            <ul id="sidebarnav">
                ...
                <?php if(adminAccessRoute(config('role.manage_plan.access.view'))): ?>
                    ...
                    <li class="sidebar-item <?php echo e(menuActive(['admin.planList','admin.planCreate','admin.planEdit*'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.product-list')); ?>" aria-expanded="false">
                            <i class="fas fa-cubes text-success"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('Product List'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
...
<?php /**PATH K:\laravel\Softtech\copy-project\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>