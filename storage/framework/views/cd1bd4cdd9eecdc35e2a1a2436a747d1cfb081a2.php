...
unset($__errorArgs, $__bag); ?>
                        ...
                        <h3 class="golden-text"><?php echo app('translator')->get(ucfirst($user->username)); ?> <sup><sapn class="badge badge-pill bg-outline-success badge_lavel_style text-white"><?php echo e(@$user->rank->rank_lavel); ?></sapn></sup> </h3>
                        <h4 class="golden-text"><?php echo e(@$user->rank->rank_name); ?></h4>
                              <p class="mb-2"><?php echo app('translator')->get('Joined At'); ?> <?php echo app('translator')->get($user->created_at->format('d M, Y g:i A')); ?></p>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH K:\laravel\Softtech\test_event\resources\views/themes/deepblack/user/profile/myprofile.blade.php ENDPATH**/ ?>