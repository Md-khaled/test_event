    ...
    <ul class="pb-4">
	   ...
	   <li class="<?php echo e(menuActive(['plan'])); ?>">
          <a href="<?php echo e(route('plan')); ?>" class="sidebar-link">
             <img src="<?php echo e(asset($themeTrue.'img/icon/growth-graph.png')); ?>" alt="<?php echo app('translator')->get('invest history'); ?>"/><?php echo app('translator')->get('Products'); ?>
          </a>
        </li>
...
<?php /**PATH K:\laravel\Softtech\copy-project\resources\views/themes/deepblack/partials/sidebar.blade.php ENDPATH**/ ?>