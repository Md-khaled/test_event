            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?php echo app('translator')->get('Offer Price'); ?></th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $managePlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-label="<?php echo app('translator')->get('Descriptione'); ?>">
                                <p class="font-weight-bold"><?php echo e(Str::words($item->description, 10)); ?></p>
                            </td>

                            <td data-label="<?php echo app('translator')->get('Category'); ?>">
                                <p class="font-weight-bold"><?php echo e(["Category 1", "Category 2", "Category 3", "Category 4"][$item->category_id]); ?></p>
                            </td>

                            <td data-label="<?php echo app('translator')->get('Sub Category'); ?>">
                                <p class="font-weight-bold"><?php echo e(["Sub Category 1", "Sub Category 2", "Sub Category 3", "Sub Category 4"][$item->subcategory_id]); ?></p>
                            </td>
                            ...
                            <td data-label="<?php echo app('translator')->get('Offer Price'); ?>">
                                <p class="font-weight-bold"><?php echo e($item->price - $item->price*($item->discount/100)); ?></p>
                            </td>

                            <td data-label="<?php echo app('translator')->get('Points'); ?>">
                                <p class="font-weight-bold"><?php echo e($item->point); ?></p>
                            </td>

                            <td data-label="<?php echo app('translator')->get('Stock'); ?>">
                                <p class="font-weight-bold"><?php echo e($item->stock); ?></p>
                            </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH K:\laravel\Softtech\copy-project\resources\views/admin/product/list.blade.php ENDPATH**/ ?>