                    ...
                    <div class="box">
                        ...
                        <div class="input-group">
                            ...
                            <button class="gold-btn copytext" id="copyBoard" onclick="copyFunction()"><i
                                    class="fa fa-copy mx-1"></i><?php echo app('translator')->get('copy link'); ?></button>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/theenproduct24/my.theenproduct.com/resources/views/themes/deepblack/user/dashboard.blade.php ENDPATH**/ ?>